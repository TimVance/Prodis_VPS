...
{		           
	echo '<div class="news block box-block">';
	...
	echo '<div class="block-text">';
        ...
        echo '<a href="'.BASE_PATH_HREF.$row["link"].'" class="main_news__title">'.$row["name"].'</a>';
		...
		if(! empty($row["anons"]))
		{
			echo '<div class="news_anons anons">'.mb_substr($row['anons'], 0, 600).'...</div>';
		}
