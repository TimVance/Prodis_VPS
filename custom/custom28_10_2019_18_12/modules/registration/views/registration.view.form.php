...
<div class="forms__field">
	<div class="forms__label infofield">'.$this->diafan->_('ФИО или название компании').'<span style="color:red;">*</span>:</div>
	<input type="text" name="fio" value="" placeholder="Ваше ФИО или название компании">
	<div class="errors error_fio"'.($result["error_fio"] ? '>'.$result["error_fio"] : ' style="display:none">').'</div>
</div>

<div class="forms__field">
	<div class="forms__label infofield">'.$this->diafan->_('E-mail').'<span style="color:red;">*</span>:</div>
	<input type="email" name="mail" value="" placeholder="Введите email">
	<div class="errors error_mail"'.($result["error_mail"] ? '>'.$result["error_mail"] : ' style="display:none">').'</div>
</div>

<div class="forms__field">
	<div class="forms__label infofield">'.$this->diafan->_('Телефон').':</div>
	<input type="tel" name="phone" value="" placeholder="+7 999 999 99 99">
...
if($result["use_name"])
{
	echo '
	<div class="forms__field">
		<div class="forms__label infofield">'.$this->diafan->_('Логин').'<span style="color:red;">*</span>:</div>
...
echo '
<div class="forms__field">
	<div class="infofield forms__label">'.$this->diafan->_('Пароль').'<span style="color:red;">*</span>:</div>
	<input type="password" name="password">
	<div class="errors error_password"'.($result["error_password"] ? '>'.$result["error_password"] : ' style="display:none">').'</div>
</div>

<div class="forms__field">
	<div class="infofield forms__label">'.$this->diafan->_('Повторите пароль').'<span style="color:red;">*</span>:</div>
...
<div class="forms__field">
	<div class="forms__hint privacy_field">'.$this->diafan->_('Отправляя форму, я даю согласие на <a href="%s">обработку персональных данных</a>.', true, BASE_PATH_HREF.'privacy'.ROUTE_END).'</div>
</div>

<input type="submit" value="'.$this->diafan->_('Регистрация', false).'" class="button"/>
