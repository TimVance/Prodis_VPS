	...
	public function edit_variable_category()
	{
		...
		if(count($rows) == $max)
		{
			...
			<div class="unit" id="cat_ids">
				<div class="infofield">'.$this->diafan->_('Город').$this->diafan->help()
			...
			echo '
				<div class="additional_cat_ids">
					...
					.$this->diafan->_('Добавить город').': <input type="text" name="cat_search" value="" size="30">'
				.'</div>';
			foreach($cats as $cat)
			{
		...
		echo '
		<div class="unit" id="cat_ids">
			<div class="infofield">'.$this->diafan->_('Город').$this->diafan->help().'</div>';
