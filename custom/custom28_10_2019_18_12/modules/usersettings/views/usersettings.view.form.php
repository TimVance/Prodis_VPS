...
echo '<form action="'.$result["action"].'" method="POST" class="usersettings_form ajax forms" enctype="multipart/form-data">
...
if($result["use_name"])
{
    echo '<div class="forms__field"><div class="infofield">'.$this->diafan->_('Логин').':</div>
	<input type="text" name="name" value="'.$result["name"].'">
	<div class="errors error_name"'.($result["error_name"] ? '>'.$result["error_name"] : ' style="display:none">').'</div></div>';
}
echo '
    <div class="forms__field">
        <div class="infofield">'.$this->diafan->_('Пароль').':</div>
...
<input type="submit" class="button" value="'.$this->diafan->_('Сохранить', false).'">
